...
POSITIONS: list[dict[str, Any]] = [
    # 8 open
    {
        ...
        "required_skills": ["React", "Vue", "TypeScript", "Webpack", "Node.js"],
        "required_exp_min": 5,
        "required_exp_max": 10,
        "priority": "high",
        "headcount": 2,
    ...
    },
    {
        ...
        "required_skills": ["PyTorch", "NLP", "Transformer", "Python", "ML"],
        "required_exp_min": 3,
        "required_exp_max": 8,
        "priority": "high",
        "headcount": 2,
    ...
    },
    {
        ...
        "required_skills": ["产品设计", "需求分析", "Axure", "SQL", "数据分析"],
        "required_exp_min": 3,
        "required_exp_max": 8,
        "priority": "normal",
        "headcount": 1,
    ...
    },
    {
        ...
        "required_skills": ["Figma", "Sketch", "交互设计", "用户研究", "设计系统"],
        "required_exp_min": 3,
        "required_exp_max": 7,
        "priority": "normal",
        "headcount": 1,
    ...
    },
    {
        ...
        "required_skills": ["项目管理", "Agile", "Scrum", "JIRA", "风险管理"],
        "required_exp_min": 5,
        "required_exp_max": 10,
        "priority": "normal",
        "headcount": 1,
    ...
    },
    {
        ...
        "required_skills": ["SQL", "Python", "Tableau", "Excel", "统计学"],
        "required_exp_min": 2,
        "required_exp_max": 5,
        "priority": "normal",
        "headcount": 2,
    ...
    # 2 closed
    {
        ...
        "required_skills": ["市场推广", "活动策划", "SEO", "SEM", "社媒运营"],
        "required_exp_min": 2,
        "required_exp_max": 5,
        "priority": "normal",
        "headcount": 1,
    ...
    },
    {
        ...
        "required_skills": ["HRBP", "组织发展", "绩效管理", "人才发展", "劳动法"],
        "required_exp_min": 3,
        "required_exp_max": 8,
        "priority": "normal",
        "headcount": 1,
    ...
    # 2 filled
    {
        ...
        "required_skills": ["财务分析", "Excel", "SAP", "预算管理", "风险管理"],
        "required_exp_min": 3,
        "required_exp_max": 7,
        "priority": "normal",
        "headcount": 1,
    ...
    },
    {
        ...
        "required_skills": ["运营策略", "数据分析", "用户增长", "团队管理", "项目协调"],
        "required_exp_min": 5,
        "required_exp_max": 10,
        "priority": "high",
        "headcount": 1,
