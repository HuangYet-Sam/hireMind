export default {
  ...
  sidebar: {
    ...
    groupRecruitment: 'Personalbeschaffung',
    groupAiAssistant: 'KI-Assistent',
    groupSystem: 'System',
    groupAnalytics: 'Analytik',
    hrDashboard: 'Dashboard',
    hrOrgChart: 'Organigramm',
    hrPositions: 'Stellen',
    hrResumes: 'Lebensläufe',
    hrCandidates: 'Kandidaten',
    hrMatching: 'Matching',
    hrInterviews: 'Vorstellungsgespräche',
    hrOffers: 'Angebote',
    hrAnalytics: 'Analytik',
    hrTasks: 'KI-Aufgaben',
    hrCron: 'Cron-Manager',
    hrSkillRegistry: 'Skill-Registry',
    hrAiTaskCenter: 'KI-Aufgabencenter',
    hrDailyReport: 'Tagesbericht',
