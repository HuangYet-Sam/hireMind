export default {
  ...
  sidebar: {
    ...
    hrMatching: 'Matching',
    hrInterviews: 'Interviews',
    hrOffers: 'Offers',
    hrAnalytics: 'Recruitment Analytics',
    hrTasks: 'AI Tasks',
    hrCron: 'Cron Manager',
    hrSkillRegistry: 'Skill Registry',
    hrAiTaskCenter: 'AI Task Center',
    hrDailyReport: 'Daily Report',
  ...
  hr: {
    resumeDetail: {
      ...
      rawParsedData: 'Raw Parsed Data',
      noSkills: 'No skills extracted',
      noEducation: 'No education extracted',
      noWorkExperience: 'No work experience extracted',
      parsing: 'Parsing in progress, please refresh later',
      pendingParse: 'Pending parse',
      parseFailed: 'Parse failed or not yet parsed',
      aiOperations: 'AI Operations',
      aiSummary: 'AI Summarize Resume',
      aiInterviewQuestions: 'AI Generate Interview Questions',
      aiMatchScore: 'AI Match Score',
      aiExtractInfo: 'AI Extract Key Info',
      aiComingSoon: 'AI operations coming soon',
      fileName: 'File Name',
      fileSize: 'File Size',
    ...
    public: {
      ...
      comment: 'Comments',
      commentPlaceholder: 'Please enter your feedback on the interview process...',
      otherSuggestions: 'Other Suggestions',
      otherSuggestionsPlaceholder: 'Any other suggestions or comments...',
      submit: 'Submit Feedback',
      submitSuccess: 'Submitted successfully',
      submitFailed: 'Submission failed',
      onboardingTitle: 'Onboarding Materials Upload',
      onboardingDesc: 'Please upload your onboarding materials, including ID, degree certificate, resignation letter, etc.',
      selectFiles: 'Select Files',
      submitMaterials: 'Submit Materials',
      uploadedFiles: 'Uploaded Files',
      uploadSuccess: 'Upload successful',
      uploadFailed: 'Upload failed',
      materialsSubmitted: 'Onboarding materials submitted',
      selectFilesFirst: 'Please select files first',
      shareDashboardTitle: 'Shared Dashboard',
      shareDashboardComingSoon: 'Shared dashboard coming soon',
      candidateProfileTitle: 'Candidate Profile',
      candidateProfilePhase2: 'This feature will be available in a future release (Phase 2)',
      offerResponseTitle: 'Offer Response',
      offerResponsePhase2: 'This feature will be available in a future release (Phase 2)',
    },
  },
