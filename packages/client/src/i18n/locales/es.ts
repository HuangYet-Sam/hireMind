export default {
  ...
  sidebar: {
    ...
    groupRecruitment: 'Reclutamiento',
    groupAiAssistant: 'Asistente de IA',
    groupSystem: 'Sistema',
    groupAnalytics: 'Analítica',
    hrDashboard: 'Panel',
    hrOrgChart: 'Organigrama',
    hrPositions: 'Puestos',
    hrResumes: 'Currículums',
    hrCandidates: 'Candidatos',
    hrMatching: 'Emparejamiento',
    hrInterviews: 'Entrevistas',
    hrOffers: 'Ofertas',
    hrAnalytics: 'Analítica de Reclutamiento',
    hrTasks: 'Tareas de IA',
    hrCron: 'Gestor de Cron',
    hrSkillRegistry: 'Registro de Skills',
    hrAiTaskCenter: 'Centro de Tareas IA',
    hrDailyReport: 'Informe Diario',
