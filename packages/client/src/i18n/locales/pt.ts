export default {
  ...
  sidebar: {
    ...
    groupRecruitment: 'Recrutamento',
    groupAiAssistant: 'Assistente de IA',
    groupSystem: 'Sistema',
    groupAnalytics: 'Análise',
    hrDashboard: 'Painel',
    hrOrgChart: 'Organograma',
    hrPositions: 'Vagas',
    hrResumes: 'Currículos',
    hrCandidates: 'Candidatos',
    hrMatching: 'Correspondência',
    hrInterviews: 'Entrevistas',
    hrOffers: 'Ofertas',
    hrAnalytics: 'Análise de Recrutamento',
    hrTasks: 'Tarefas de IA',
    hrCron: 'Gerenciador Cron',
    hrSkillRegistry: 'Registro de Skills',
    hrAiTaskCenter: 'Centro de Tarefas IA',
    hrDailyReport: 'Relatório Diário',
    hrBackToMain: 'Voltar ao início',
    logout: 'Sair',
