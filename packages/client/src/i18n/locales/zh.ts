export default {
  ...
  sidebar: {
    ...
    hrTasks: 'AI任务中心',
    hrCron: 'Cron管理',
    hrSkillRegistry: 'Skill注册中心',
    hrAiTaskCenter: 'AI任务中心',
    hrDailyReport: '日报预览',
    hrBackToMain: '返回主界面',
    connected: '已连接',
    disconnected: '未连接',
  ...
  hr: {
    resumeDetail: {
      ...
      education: '教育经历',
      workExperience: '工作经历',
      rawParsedData: '原始解析数据',
      noSkills: '未提取到技能',
      noEducation: '未提取到教育经历',
      noWorkExperience: '未提取到工作经历',
      parsing: '正在解析中，请稍后刷新页面',
      pendingParse: '等待解析',
      parseFailed: '解析失败或尚未解析',
      aiOperations: 'AI 操作',
      aiSummary: 'AI 总结简历',
      aiInterviewQuestions: 'AI 生成面试问题',
      aiMatchScore: 'AI 评估匹配度',
      aiExtractInfo: 'AI 提取关键信息',
      aiComingSoon: 'AI 操作功能即将上线，敬请期待',
      fileName: '文件名',
      fileSize: '文件大小',
    ...
    public: {
      ...
      feedbackDesc: '您的意见对我们非常重要。',
      rating: '总体评分',
      comment: '评价意见',
      commentPlaceholder: '请输入您对面试过程、面试官等方面的评价...',
      otherSuggestions: '其他建议',
      otherSuggestionsPlaceholder: '任何其他建议或意见...',
      submit: '提交反馈',
      submitSuccess: '提交成功',
      submitFailed: '提交失败',
      onboardingTitle: '入职材料上传',
      onboardingDesc: '请上传您的入职所需材料，包括身份证、学历证明、离职证明等。',
      selectFiles: '选择文件',
      submitMaterials: '提交材料',
      uploadedFiles: '已上传文件',
      uploadSuccess: '上传成功',
      uploadFailed: '上传失败',
      materialsSubmitted: '入职材料已提交',
      selectFilesFirst: '请先选择文件',
      shareDashboardTitle: '共享看板',
      shareDashboardComingSoon: '共享看板功能即将上线，敬请期待',
      candidateProfileTitle: '候选人信息',
      candidateProfilePhase2: '此功能将在后续版本开放 (Phase 2)',
      offerResponseTitle: 'Offer 回应',
      offerResponsePhase2: '此功能将在后续版本开放 (Phase 2)',
    },
  },
