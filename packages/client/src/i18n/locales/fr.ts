export default {
  ...
  sidebar: {
    ...
    groupRecruitment: 'Recrutement',
    groupAiAssistant: 'Assistant IA',
    groupSystem: 'Système',
    groupAnalytics: 'Analytique',
    hrDashboard: 'Tableau de bord',
    hrOrgChart: 'Organigramme',
    hrPositions: 'Postes',
    hrResumes: 'CV',
    hrCandidates: 'Candidats',
    hrMatching: 'Correspondance',
    hrInterviews: 'Entretiens',
    hrOffers: 'Offres',
    hrAnalytics: 'Analytique de recrutement',
    hrTasks: 'Tâches IA',
    hrCron: 'Gestionnaire Cron',
    hrSkillRegistry: 'Registre de Skills',
    hrAiTaskCenter: 'Centre de Tâches IA',
    hrDailyReport: 'Rapport Quotidien',
    hrBackToMain: "Retour à l'accueil",
    logout: 'Deconnexion',
